...
* **Stealth Passcode Engine**: Zero input boxes or text fields. The user simply types their pre-set passcode directly on the keyboard to unlock.
...
* **Touchpad & Cursor Protection**: Instantly trips alarm on any mouse cursor displacement (> 4px) or click event.
...
Developed by CyberHorizon Ltd (cyberhorizon.hu).
